...
use asset_io::{Asset, PngHandler, FormatHandler, Updates, XmpUpdate, JumbfUpdate};
use std::fs::File;
...
fn main() -> asset_io::Result<()> {
  ...
  <rdf:Description rdf:about=\"\">
    ...
    asset.write_to("/tmp/png_with_xmp.png", &Updates {
    ...
    output_asset.write_to("/tmp/png_with_c2pa.png", &Updates {
