...
fn main() -> asset_io::Result<()> {
    ...
    asset.write_to(output_path, &Updates::new().set_jumbf(placeholder_manifest.clone()))?;
    ...
    let capacity = asset.jumbf_capacity()
        .ok_or_else(|| asset_io::Error::InvalidFormat("No JUMBF found in output file".to_string()))?;
