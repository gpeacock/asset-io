...
fn main() -> asset_io::Result<()> {
    ...
    if args.len() != 4 {
        ...
        eprintln!("  {} photo.jpg dc:description \"A beautiful sunset\"", args[0]);
        std::process::exit(1);
    }
    ...
    let xmp_capacity = asset.xmp_capacity()
        .ok_or_else(|| asset_io::Error::InvalidFormat("No XMP metadata found in file".to_string()))?;
