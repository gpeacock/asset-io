...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let mmap_avg: std::time::Duration = mmap_times.iter().sum::<std::time::Duration>() / runs as u32;
    ...
    let regular_avg: std::time::Duration = regular_times.iter().sum::<std::time::Duration>() / runs as u32;
    ...
    println!("Throughput gain: {:.0} MB/s", mmap_throughput - regular_throughput);
